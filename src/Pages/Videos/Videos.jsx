...
const courses = [
  { key: "course1", image: "https://images.unsplash.com/photo-1580587771525-78b9dba3b914?auto=format&fit=crop&w=800&q=80" },
  { key: "course2", image: "https://images.unsplash.com/photo-1593642532973-d31b6557fa68?auto=format&fit=crop&w=800&q=80" },
  { key: "course3", image: "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=800&q=80" }
];
    ...
    <div className="bg-[#f8f7f3]">
      ...
      <div className="max-w-6xl mx-auto py-12 sm:py-16 px-4 sm:px-6">
        ...
        <div className="grid gap-6 sm:gap-8 md:gap-10 grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
          {courses.map((course) => (
            <div key={course.key} className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition cursor-pointer flex flex-col">
              <img src={course.image} alt={t(`videosPage.${course.key}.title`)} className="w-full h-48 sm:h-56 md:h-64 object-cover" />
              <div className="p-4 sm:p-6 flex flex-col flex-1">
                ...
                <a href="https://yourcompanywebsite.com" target="_blank" rel="noopener noreferrer" className="text-neutral-900 font-medium hover:underline text-sm sm:text-base mt-auto">
                  {t("videosPage.preview")}
                </a>
              </div>
            </div>
