...
function Homepage() {
  ...
  // Advantages with translation keys
  const advantages = [
    {
      icon: <IconProject />,
      title: t("homepage.advantages.projects.title"),
      description: t("homepage.advantages.projects.desc"),
    },
    {
      icon: <IconClients />,
      title: t("homepage.advantages.clients.title"),
      description: t("homepage.advantages.clients.desc"),
    },
    {
      icon: <IconRevenue />,
      title: t("homepage.advantages.revenue.title"),
      description: t("homepage.advantages.revenue.desc"),
    },
    {
      icon: <IconAwards />,
      title: t("homepage.advantages.awards.title"),
      description: t("homepage.advantages.awards.desc"),
    },
  ];
      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12 max-w-6xl mx-auto">
          {advantages.map(({ icon, title, description }, idx) => (
            <div key={idx} className="bg-black rounded-xl p-6 sm:p-8 shadow-lg hover:shadow-2xl transition-shadow duration-300">
              {icon}
      ...
      >
        ...
        <div className="space-y-6 sm:space-y-8">
          <blockquote className="bg-[#111] p-6 sm:p-8 rounded-xl shadow-md italic text-gray-300">
            {t("homepage.reviews.review1.text")}
            <footer className="mt-4 font-semibold text-gold">— {t("homepage.reviews.review1.author")}</footer>
          </blockquote>
          <blockquote className="bg-[#111] p-6 sm:p-8 rounded-xl shadow-md italic text-gray-300">
            {t("homepage.reviews.review2.text")}
            <footer className="mt-4 font-semibold text-gold">— {t("homepage.reviews.review2.author")}</footer>
          </blockquote>
        </div>
      </section>
